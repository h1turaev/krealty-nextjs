import { CREATE_NOTIFICATION, CREATE_PROPERTY, UPDATE_PROPERTY } from '@/apollo/user/mutation';
import { GET_MEMBER_FOLLOWERS, GET_PROPERTY } from '@/apollo/user/query';
        ...
        try {
          ...
          const notificationPromises = followers.map((follow: any) => {
            ...
            const notificationInput: NotificationInput = {
              ...
              notificationTitle: `${user.memberFullName || user.memberNick} added a new property: ${
                insertPropertyData.propertyTitle
              }`,
      ...
      <div id="add-property-page">
        <Stack className="main-title-box">
          ...
          <Typography className="sub-title">
            Create a new property listing for your store
          </Typography>
        </Stack>

        <div>
          <Stack className="config">
            <Stack className="property-info-section">
              <Typography className="section-title">Property Information</Typography>
            ...
            <Stack className="property-images-section">
              <Typography className="section-title">Property Images</Typography>
